...
const styles = StyleSheet.create({
  ...
  touchContainer:{ flexDirection: 'row', width: '48%', height: 'auto', marginRight: '2%', },

  touch:{ width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', borderColor: '#dad9e2', borderWidth: .5, marginBottom: 2, },

  innerTouch:{ minHeight: 50, width: '100%', flexDirection: 'row', justifyContent: 'space-between', padding: 2, backgroundColor: 'white', shadowOffset:{  width: 4,  height: 8,  }, shadowColor: 'grey', shadowOpacity: .75, borderRadius: 7, padding: 5, borderColor: '#212121', borderWidth: .5, },
